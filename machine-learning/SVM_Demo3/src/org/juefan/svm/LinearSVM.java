...
public class LinearSVM {
	...
	public void Train(List<Data> datas, int iterator){
		...
		System.out.println("The amount of data：" + exampleNum + "\tData dimension：" + exampleDim);
	...
	public void Test(List<Data> datas){
		...
		System.out.println("Number of test cases：" + datas.size());
		System.out.println("errors：" + error);
		System.out.println("Accuracy：" + (double)(datas.size() - error)/datas.size());
	}
		
	public static void main(String[] args) throws IOException{
		
		FileIO file = new FileIO();
		file.setFileName("/Users/vpati/Intuit_project/ml/svm/StatisticsLearningMethod/file/svm.train3.txt");
		...
		file.setFileName("/Users/vpati/Intuit_project/ml/svm/StatisticsLearningMethod/file/svm.test3.txt");
