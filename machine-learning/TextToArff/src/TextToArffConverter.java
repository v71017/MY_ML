...
public class TextToArffConverter {
	...
	clock.start();
		...
		converter.initialize("/Users/vpati/Downloads/ml_data/stopwords.txt");
		converter.convertTextToArff("/Users/vpati/Downloads/ml_data/sms1000.dat", "out.arff", true, true, 2, "NORMTFIDF"); //"BINARY", "NORMFREQ", "NORMTFIDF"
	clock.stop();
