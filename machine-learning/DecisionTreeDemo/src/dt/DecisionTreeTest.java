...
public class DecisionTreeTest {
  ...
  final Logger logger = LoggerFactory.getLogger(DecisionTreeTest.class);
  ...
  @Test public void testOutlookOvercastApplyReturnsTrue() throws BadDecisionException {
    ...
    System.out.println("aaaa " + makeOutlookTree().apply(case1));
    logger.debug("aaaa {}.", makeOutlookTree().apply(case1));
  }
